...
internal readonly unsafe ref struct ComScope<T> where T : unmanaged
{
    ...
    public ComScope<TInterface> QueryInterface<TInterface>(out HRESULT hr) where TInterface : unmanaged, INativeGuid
        => ((IUnknown*)_value)->QueryInterface<TInterface>(out hr);

    public ComScope<TInterface> QueryInterface<TInterface>(out bool success) where TInterface : unmanaged, INativeGuid
        => ((IUnknown*)_value)->QueryInterface<TInterface>(out success);
