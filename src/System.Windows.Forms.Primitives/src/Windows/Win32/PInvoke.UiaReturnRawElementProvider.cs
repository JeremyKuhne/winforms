...
internal static partial class PrimitivesPInvokeExtensions
{
    extension(PInvoke)
    {
        /// <inheritdoc cref="PInvoke.UiaReturnRawElementProvider(HWND, WPARAM, LPARAM, IRawElementProviderSimple*)"/>
            ...
            where T : IHandle<HWND>
        {
            ...
            LRESULT result = PInvoke.UiaReturnRawElementProvider(hwnd.Handle, wParam, lParam, provider);
