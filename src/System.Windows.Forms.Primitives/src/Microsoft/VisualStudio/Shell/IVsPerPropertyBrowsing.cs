...
internal unsafe struct IVsPerPropertyBrowsing : INativeGuid
{
    internal static readonly Guid Guid = new Guid(0x0FF510A3, 0x5FA5, 0x49F1, 0x8C, 0xCC, 0x19, 0x0D, 0x71, 0x08, 0x3F, 0x3E);
    ...
    /// <inheritdoc cref="Interface.GetLocalizedPropertyInfo(int, PInvoke.LCID, BSTR*, BSTR*)"/>
    ...
    {
        fixed (IVsPerPropertyBrowsing* pThis = &this)
            return ((delegate* unmanaged[Stdcall]<IVsPerPropertyBrowsing*, int, PInvoke.LCID, BSTR*, BSTR*, HRESULT>)_lpVtbl[5])(
                pThis,
                dispid,
                localeID,
                pbstrLocalizedName,
