...
internal unsafe struct IVSMDPerPropertyBrowsing : INativeGuid
{
    internal static readonly Guid Guid = new Guid(0x7494683C, 0x37A0, 0x11D2, 0xA2, 0x73, 0x00, 0xC0, 0x4F, 0x8E, 0xF4, 0xFF);
