...
internal unsafe partial struct IMsoComponentManager
{
    ...
    internal unsafe interface Interface
    {
        ...
        /// <returns>
        ///  <see cref="HRESULT.S_OK"/> if the requested service is supported, otherwise appropriate error such
        ///  as <see cref="HRESULT.E_FAIL"/>, <see cref="HRESULT.E_NOINTERFACE"/>.
        /// </returns>
        [PreserveSig]
        ...
        ///   <see cref="IMsoComponent.FContinueMessageLoop(msoloop, void*, MSG*)"/> during each loop iteration. When
        ///   <see cref="IMsoComponent.FContinueMessageLoop(msoloop, void*, MSG*)"/> returns <see cref="BOOL.FALSE"/>,
