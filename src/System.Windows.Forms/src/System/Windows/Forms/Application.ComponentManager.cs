...
public sealed partial class Application
{
    ...
    ///  </para>
    /// </remarks>
    private unsafe class ComponentManager : IMsoComponentManager.Interface, IManagedWrapper<IMsoComponentManager>
    {
            ...
            void* pvLoopData)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    IMsoComponent* component = _trackingComponent is not null
                        ? _trackingComponent
                        : _activeComponent is not null ? _activeComponent : requestingComponent;
        ...
        unsafe BOOL IMsoComponentManager.Interface.FCreateSubComponentManager(
            IUnknown* punkOuter,
            ...
            uint dwReserved)
        {
            IMsoComponent* component = dwgac switch
            {
                ...
                msogac.TrackingOrActive => _trackingComponent is not null ? _trackingComponent : _activeComponent,
                _ => null
            };
