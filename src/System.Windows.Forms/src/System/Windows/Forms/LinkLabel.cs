...
namespace System.Windows.Forms
{
    ...
    public class LinkLabel : Label, IButtonControl
    {
        ...
        bool _processingOnGotFocus;  // used to avoid raising the OnGotFocus event twice after selecting a focus link.

        LinkBehavior _linkBehavior = LinkBehavior.SystemDefault;
