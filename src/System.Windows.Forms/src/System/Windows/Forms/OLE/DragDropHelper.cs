    ...
    where TDataFormat : IDataFormat<TDataFormat>
{
    ...
    /// </summary>
    public static void ClearDropDescription(object? dataObject)
    {
        if (dataObject is not IDataObject.Interface comDataObject)
        {
            return;
        }

        SetDropDescription(comDataObject, DROPIMAGETYPE.DROPIMAGE_INVALID, string.Empty, string.Empty);
    }
    ...
    {
        if (e.Data is not IDataObject.Interface dataObject)
        {
            return;
        }
    ...
    ///  needed to display the drag image.
    /// </summary>
    public static void DragEnter(HWND targetWindowHandle, IDataObject.Interface dataObject, ref Point point, DROPEFFECT effect)
    {
    ...
    {
        using ComScope<IDropTargetHelper> dropTargetHelper = new(null);
        if (!TryGetDragDropHelper<IDropTargetHelper>(dropTargetHelper) || e.Data is not IDataObject.Interface dataObject)
        {
            return;
        }
    ...
    /// </summary>
    private static unsafe bool GetBooleanFormat(IDataObject.Interface dataObject, string format)
    {
        ...
        try
        {
            ...
            if (dataObject.QueryGetData(&formatEtc) != (int)HRESULT.S_OK)
            {
                return false;
            }

            dataObject.GetData(&formatEtc, &medium);
        ...
        finally
        {
            ...
            PInvokeCore.ReleaseStgMedium(&medium);
        }
    }
    ...
    ///  <see langword="true"/> if <paramref name="dataObject"/> is in a drag-and-drop loop; otherwise <see langword="false"/>.
    /// </returns>
    public static bool IsInDragLoop(IDataObject.Interface dataObject) => GetBooleanFormat(dataObject, PInvokeCore.CFSTR_INDRAGLOOP);
    ...
    /// </summary>
    public static void ReleaseDragDropFormats(IDataObject.Interface comDataObject)
    {
        if (comDataObject is not IDataObjectInternal dataObject)
        {
            return;
        }
    ...
    /// </summary>
    private static unsafe void SetBooleanFormat(IDataObject.Interface dataObject, string format, bool value)
    {
        ArgumentNullException.ThrowIfNull(dataObject);
        ArgumentException.ThrowIfNullOrEmpty(format);
    ...
    ///  </para>
    /// </remarks>
    public static void SetDragImage(IDataObject.Interface dataObject, IGiveFeedbackEvent e)
    {
    ...
    ///  </para>
    /// </remarks>
    public static void SetDragImage(IDataObject.Interface dataObject, IBitmap? dragImage, Point cursorOffset, bool usingDefaultDragImage)
    {
        ArgumentNullException.ThrowIfNull(dataObject);
    ...
    public static unsafe void SetDropDescription(
        IDataObject.Interface dataObject,
    ...
    ///  </para>
    /// </remarks>
    public static void SetInDragLoop(IDataObject.Interface dataObject, bool inDragLoop)
    {
    ...
    ///  </para>
    /// </remarks>
    private static void SetIsShowingText(IDataObject.Interface dataObject, bool isShowingText)
    ...
    ///  </para>
    /// </remarks>
    private static void SetUsingDefaultDragImage(IDataObject.Interface dataObject, bool usingDefaultDragImage)
