...
[Designer($"System.Windows.Forms.Design.PrintDialogDesigner, {Assemblies.SystemDesign}")]
    ...
    private unsafe bool ShowPrintDialog(HWND hwndOwner)
    {
        ...
        try
        {
            ...
            BOOL result = RuntimeInformation.ProcessArchitecture == Architecture.X86
                ? PInvokeForms.PrintDlg(&dialogSettings32)
                : PInvokeForms.PrintDlg(&dialogSettings64);
